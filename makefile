...
CODE_DIRS= ./user_app/src/ ./drivers/src/ ./modules/src/ ./drivers/core/src/ ./utilities/src/ ./stdlib/src/
INC_DIRS= ./user_app/inc/ ./drivers/inc/ ./modules/inc/ ./drivers/core/inc/ ./utilities/inc/ ./stdlib/inc/
